...
import projects.trab1.nodes.nodeImplementations.SimpleNode;
...
public class CustomGlobal_ extends AbstractCustomGlobal {
    ...
    public void checkProjectRequirements() {
        if (Global.isAsynchronousMode()) {
            throw new SinalgoFatalException(
                    "SampleProjectrab1 is written to be executed in synchronous mode. It doesn't work in asynchronous mode.");
        }
    }
